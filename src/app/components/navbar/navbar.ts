...
export class Navbar implements OnInit, OnDestroy {
  ...
  private userMenuHideTimer: ReturnType<typeof setTimeout> | null = null;
  ...
  showUserMenuNow() {
    this.cancelUserMenuHideTimer();
    this.showUserMenu = true;
  }

  startUserMenuHideTimer() {
    this.userMenuHideTimer = setTimeout(() => {
      this.showUserMenu = false;
    }, 300);
  }

  cancelUserMenuHideTimer() {
    if (this.userMenuHideTimer) {
      clearTimeout(this.userMenuHideTimer);
      this.userMenuHideTimer = null;
    }
  }
