...
export class LanguageService {
  ...
  private translations: Record<Language, Translations> = {
    en: {
      ...
      'checkout.phonePlaceholder': '+966 XX XXX XXXX',
      'checkout.address': 'Street Address',
      'checkout.addressPlaceholder': 'Building number, street name',
      'checkout.city': 'City',
      ...
      'checkout.orderSuccess': 'Order placed successfully! Thank you for your purchase.',
    ...
    ar: {
      ...
      'checkout.addressPlaceholder': 'رقم المبنى، اسم الشارع',
      'checkout.city': 'المدينة',
      'checkout.cityPlaceholder': 'أدخل المدينة',
      ...
      'checkout.cardNamePlaceholder': 'الاسم على البطاقة',
      ...
      'checkout.orderSuccess': 'تم تأكيد الطلب بنجاح! شكراً لشرائك.',
